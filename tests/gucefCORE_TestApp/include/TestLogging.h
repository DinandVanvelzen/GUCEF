...
/**
 *  Tests the logging backend including the streaming rework.
 *  Covers CStdLogger, CLogManager, CLogStreamScope, CMultiLogger dispatch,
 *  per-thread buffering, FlushThreadStreamBuffers, and the GUCEF_LOG macros.
