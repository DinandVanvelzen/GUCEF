...
-- Configuration for module: aws-cpp-sdk-s3
...
configuration( {} )
links( { "aws-cpp-sdk-core", "aws-crt-cpp" } )
links( { "aws-cpp-sdk-core", "aws-crt-cpp" } )


configuration( {} )
defines( { "AWS_S3_EXPORTS", "MODULE_CONSENSUS_NAME=aws_cpp_sdk_s3", "MODULE_NAME=aws_cpp_sdk_s3", "USE_IMPORT_EXPORT=1" } )
