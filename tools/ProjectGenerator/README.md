...
| **Premake4/5** | Premake project files | IDE project generation |
...
| `Linux` | Alternative Linux syntax | Legacy compatibility |
...
Support for environment variable overrides from file:# env_overrides.txt
