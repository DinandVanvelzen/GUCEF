...
#ifndef GUCEF_VFSPLUGIN_DVP_H
#define GUCEF_VFSPLUGIN_DVP_H
...
GUCEF_VFSPLUGIN_DVP_PUBLIC_C CORE::Int32 GUCEF_PLUGIN_CALLSPEC_PREFIX 
GUCEFPlugin_Load( CORE::UInt32 argc, const char** argv ) GUCEF_PLUGIN_CALLSPEC_SUFFIX;

/*--------------------------------------------------------------------------*/

GUCEF_VFSPLUGIN_DVP_PUBLIC_C void GUCEF_PLUGIN_CALLSPEC_PREFIX 
...
GUCEF_VFSPLUGIN_DVP_PUBLIC_C const char* GUCEF_PLUGIN_CALLSPEC_PREFIX 
