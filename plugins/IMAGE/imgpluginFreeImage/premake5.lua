...
configuration( {} )
defines( { "MODULE_CONSENSUS_NAME=imgpluginFreeImage" } )
...
configuration( { LINUX32 } )
defines( { "GUCEF_CODECPLUGIN_BUILD_MODULE", "MODULE_IS_PLUGIN=1", "MODULE_NAME=imgpluginFreeImage" } )
