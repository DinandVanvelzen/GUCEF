...
TWebPubSubClientFactory g_webPubSubClientFactory;
...
{GUCEF_TRACE;
    ...
    return "Generic GUCEF plugin for PUBSUB approximation using the WEB";
}
...
{GUCEF_TRACE;
    ...
    return "gucefCORE,gucefWEB,gucefPUBSUB";
}
