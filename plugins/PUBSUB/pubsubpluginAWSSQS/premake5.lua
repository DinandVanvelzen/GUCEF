...
configuration( {} )
defines( { "MODULE_CONSENSUS_NAME=pubsubpluginAWSSQS", "MODULE_IS_PLUGIN=1", "MODULE_NAME=pubsubpluginAWSSQS", "PUBSUBPLUGIN_AWSSQS_BUILD_PLUGIN_DLL", "USE_IMPORT_EXPORT" } )
