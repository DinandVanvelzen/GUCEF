...
#ifndef PUBSUBPLUGIN_MSMQ_H
#define PUBSUBPLUGIN_MSMQ_H
...
PUBSUBPLUGIN_MSMQ_PLUGIN_PUBLIC_C CORE::Int32 GUCEF_PLUGIN_CALLSPEC_PREFIX
GUCEFPlugin_Load( CORE::UInt32 argc, const char** argv ) GUCEF_PLUGIN_CALLSPEC_SUFFIX;

/*--------------------------------------------------------------------------*/

PUBSUBPLUGIN_MSMQ_PLUGIN_PUBLIC_C void GUCEF_PLUGIN_CALLSPEC_PREFIX
...
PUBSUBPLUGIN_MSMQ_PLUGIN_PUBLIC_C const char* GUCEF_PLUGIN_CALLSPEC_PREFIX
