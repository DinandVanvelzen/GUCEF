...
/**
 *  Data store codec providing an API to use native binary format for DataNode DOM trees
 */
class GUCEF_CORE_PUBLIC_CPP CDataStoreBinaryCodec : public CDStoreCodec
{
    public:

    CDataStoreBinaryCodec( void );

    virtual ~CDataStoreBinaryCodec() GUCEF_VIRTUAL_OVERRIDE;
    ...
    CDataStoreBinaryCodec( const CDataStoreBinaryCodec& src );             /**< no sense in an copied codec */
    CDataStoreBinaryCodec& operator=( const CDataStoreBinaryCodec& src );  /**< no sense in an copied codec */
