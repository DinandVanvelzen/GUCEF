...
TypeNameForGucefTypeId( UInt8 typeId )
{
    switch ( typeId )
    {
        ...
        case GUCEF_DATATYPE_LE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH: return GUCEF_DATATYPE_NAME_LE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH;
        case GUCEF_DATATYPE_BE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH: return GUCEF_DATATYPE_NAME_BE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH;
...
GucefTypeIdForTypeName( const char* typeName )
{
    ...
    {    
        ...
        if ( 0 == strcmp( GUCEF_DATATYPE_NAME_LE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH, typeName ) ) return GUCEF_DATATYPE_LE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH;
        if ( 0 == strcmp( GUCEF_DATATYPE_NAME_BE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH, typeName ) ) return GUCEF_DATATYPE_BE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH;
...
GucefByteSizeOfFixedSizeType( UInt8 varType )
{
    switch ( varType )
    {
        ...
        case GUCEF_DATATYPE_LE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH: return sizeof( UInt64 );
        case GUCEF_DATATYPE_BE_TIMESTAMP_IN_NANOS_SINCE_UNIX_EPOCH: return sizeof( UInt64 );
